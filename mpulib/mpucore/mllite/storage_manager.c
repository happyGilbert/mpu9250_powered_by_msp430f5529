...
/** Data format in flash:(header means data_header_t type data, it has three elements: size, chechsum and key)
 * | header(Defaultkey, totalsize) | header0(key0, data0size) | data0 | header1(key1, data1size) | data1 |...| headeri(keyi, dataisize) | datai |...|
 * |<---totalsize-----------------------------------------------------------------------------------------------------------------------------------|
 * header's checksum is for:       |<---------------------------------------------------------------------------------------------------------------|
 * headeri has special keyi, dataisize is the bytes of datai, checksum is for datai.
 */
